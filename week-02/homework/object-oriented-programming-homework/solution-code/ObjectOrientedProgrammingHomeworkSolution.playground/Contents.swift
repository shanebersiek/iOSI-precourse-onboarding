...
class Dog {
  ...
  static func configure(_ dog: Dog, withName name: String, barkSound: String? = nil) {
    dog.name = name
...
Dog.configure(ein, withName: "Ein")
...
Dog.configure(potato, withName: "Taters", barkSound: "grr!")
