...
class GroceryColorViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //BUG: The below block does not work as it overrides the backgroundColor previously specified by 'Banana' and 'Orange' groceries.
...
//        }
        ...
        if self.grocery.title == "Red Apple" {
