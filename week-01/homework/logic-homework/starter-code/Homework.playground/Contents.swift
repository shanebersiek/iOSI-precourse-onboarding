...
let thirdCharacterI2ndex = string.index(after: secondCharacterIndex)
print(string.characters[thirdCharacterI2ndex])
...
for characters in lowercaseString.characters {
    
    uppercaseString += String(characters).uppercased()
...
// TODO: Print out all two-digit combinations of 0-9 (e.g. 00, 01, 02... 10, 11, 12.. 90, 91, 92... 99). Repeats are allowed, use a for loop within a for loop. numbersString should take the format: 000102030405060708091011121314... See the unit test below for the expected result.
var numbersString = ""
